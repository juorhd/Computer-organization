...
int main(int argc, char *argv[])
{
   ...
   printf("decoder(0,0)|%2d,%2d,%2d,%2d\n", O0,O1,O2,O3);
   decoder(0,1,&O0,&O1,&O2,&O3);
   printf("decoder(0,1)|%2d,%2d,%2d,%2d\n", O0,O1,O2,O3);
   decoder(1,0,&O0,&O1,&O2,&O3);
   printf("decoder(1,0)|%2d,%2d,%2d,%2d\n", O0,O1,O2,O3);
   decoder(1,1,&O0,&O1,&O2,&O3);
   printf("decoder(1,1)|%2d,%2d,%2d,%2d\n", O0,O1,O2,O3);
...
{
    if ((X==FALSE && Y==TRUE) || (Y==FALSE && X==TRUE)) {
        return TRUE;
    } else {
        return FALSE;
    }
...
{ 
    return I0*not_gate(S0)*not_gate(S1)
          +I1*not_gate(S0)*S1
          +I2*S0*not_gate(S1)
          +I3*S0*S1;
}
...
BIT sr_latch(BIT S, BIT R, BIT Q)
{
   ...
   if( S==TRUE && R==FALSE) return 1;
   if( S==FALSE && R==TRUE) return 0;
   else return Q;
}
